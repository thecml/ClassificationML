...
\begin{figure}[H]
	\centering
	\frame{\includegraphics[width=0.6\linewidth]{../ML/results/ORL_PCA}}
...
\begin{figure}[H]
	\centering
	\frame{\includegraphics[width=0.6\linewidth]{../ML/results/MNIST_PCA}}
...
\begin{figure}[H]
	\centering
	\frame{\includegraphics[width=0.6\linewidth]{../ML/results/ORL_Perceptron_BP}}
...
\begin{figure}
	\centering
	\frame{\includegraphics[width=0.6\linewidth]{../ML/results/MNIST_PerceptronLine_BP_1D_PCA}}
...
\begin{figure}
	\centering
	\frame{\includegraphics[width=0.6\linewidth]{../ML/results/MNIST_PerceptronLine_BP_2D_PCA}}
...
\begin{figure}[H]
	\centering
	\frame{\includegraphics[width=0.6\linewidth]{../ML/results/ORL_Perceptron_MSE}}
...
\begin{figure}[H]
	\centering
	\frame{\frame{\includegraphics[width=0.6\linewidth]{../ML/results/MNIST_Perceptron_MSE}}}
...
\begin{figure}
	\centering
	\frame{\includegraphics[width=0.6\linewidth]{../ML/results/MNIST_PerceptronLine_MSE_2D_PCA}}
